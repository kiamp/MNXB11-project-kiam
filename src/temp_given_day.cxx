...
// constructor
temp_given_day::temp_given_day(const std::string &filename)
...
void temp_given_day::CreateHistogram() {
  ...
  auto *histogram_1 = new TH1D(
      "histogram1",
      "Temperature on 15/02 from 1863-1913 ;Temperature [#circC];Entries", 50,
      -15, 15);
  ...
  auto *histogram_2 = new TH1D(
      "histogram2",
      "Temperature on 15/02 from 1972-2022 ;Temperature [#circC];Entries", 50,
      -15, 15);
  ...
  histogram_1->SetTitle(
      "Temperature on 15/02 in 1863-1913 (blue) & 1972-2022 (red)");
